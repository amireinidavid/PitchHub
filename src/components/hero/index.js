...
const Hero = () => {
  return (
    <section className="w-full m-0 p-0 overflow-x-hidden  h-full min-h-screen bg-gradient-to-l bg-gray-950 text-white flex flex-col justify-center items-center relative z-10 pb-10 overflow-hidden">
      {/* stars */}
      <div>
        <span></span>
        <span></span>
      ...
      <div className="max-w-7xl mt-24 mx-auto items-center flex flex-col md:flex-row gap-16 md:gap-40 justify-between px-4 md:px-0">
